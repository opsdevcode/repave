...
| [`chart/values-backstage.yaml`](chart/values-backstage.yaml) | Hosted catalog IDP (ADR 011; HTML workbench stays on; `/idp` → Backstage same-host Catalog; no iframe; `make chart-smoke-backstage`) |
