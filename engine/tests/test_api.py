...
def test_index_lists_blueprints(repo_root, output_config) -> None:
    ...
    assert 'id="catalog-inventory"' in response.text
    assert "catalog-inventory__category" in response.text
    assert "catalog-inventory__summary" in response.text
    assert "<details" in response.text
    assert "Catalog inventory" in response.text
    assert 'href="#catalog-inventory"' in response.text
    assert "Terraform" in response.text
    assert "Ansible" in response.text
    assert 'class="catalog-inventory__category catalog-inventory__category--terraform"' in response.text
    assert 'class="catalog-inventory__category catalog-inventory__category--ansible"' in response.text
    assert 'class="catalog-inventory__category catalog-inventory__category--policy"' in response.text
    assert 'class="catalog-inventory__category catalog-inventory__category--observability"' in response.text
