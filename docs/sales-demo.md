...
| 4 — Existing estate | Backstage `/upgrade` or `repave plan-upgrade` on terraform-minimal | “The control plane doesn’t only create repos — we plan upgrades from provenance and can open remediation PRs.” |
