...
FinOps, batch import, org scan, and roadmap evidence — Phase 4 is a product call.
...
```text
v3.21.0 today      platform GA line on main (contract freeze + DR shipped)
  │
...
| **Hosted Backstage IDP** | Named owner | Admin pages + batch import + org scan + roadmap evidence shipped; chart-smoke + GHCR image shipped; flag stays default off ([ADR 011](adr/011-hosted-backstage-idp.md)) |
...
import, org scan, and roadmap evidence shipped ([ADR 011](adr/011-hosted-backstage-idp.md)).
