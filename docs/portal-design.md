...
| **Hosted Backstage IDP** | **In progress** — named owner before default-on ([ADR 011](adr/011-hosted-backstage-idp.md)); admin pages through feedback submit shipped |
