...
| v3.0 conversational generation | `/assistant` match + citations + confirm Plan (`/generate` dry-run) + optional draft/synthesis/gated files + read-only fleet/drift/audit |
