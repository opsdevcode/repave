...
| v3.0 conversational generation | `/assistant` match + citations + optional input draft; Open form prefills allowlisted fields (guided JS does not overwrite them) |
