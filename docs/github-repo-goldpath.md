...
| Surface | How |
| --- | --- |
| Portal | Catalog **Platform** family → `github-repo-generic` form (destination team checklist and source-team select from org teams, membership sync toggle, source-team member preview, ruleset profile) |
