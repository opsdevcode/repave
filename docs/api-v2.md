...
| `POST` | `/api/v2/assistant/resolve` | generator+ | Intent → golden-path matches plus citations; optional input-only model draft (`v3.assistant.draft.enabled`; no generate) |
